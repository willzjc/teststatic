/*1638862551,,JIT Construction: v1004819769,en_US*/
...
try {
    (window.FB && !window.FB.__buffer) || (function() {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                    ...
                    a = {
                        ...
                        apprequests: {
                            transform: function(a) {
                                ...
                                a.params.frictionless && (b("sdk.Frictionless").isAllowed(a.params.to) && (a.hideLoader = !0), a.cb = b("sdk.Frictionless")._processRequestResponse(a.cb, a.hideLoader));
                                a.closeIcon = !1;
                                return a
                            },
                ...
                __d("ChatPluginStyleUtils", [], (function(a, b, c, d, e, f) {
                    var g = 44,
                        h = 36,
                        i = 60,
                        j = 44,
                    ...
                    function d(a, b, c, d, e, f) {
                        c = c + (a == "right" ? -2 : 43);
                        var k = b + i - 16;
                        e ? (k = b - 16, d === "none" ? f === "compact" ? k += j : k += i : f === "compact" ? k += h : k += g) : f === "compact" && (k = b + j - 16);
                        e = {
                    ...
                    function q(a, b, c, d, e, f, l, m) {
                        c = c - k;
                        var n = i;
                        f ? e === "none" ? l === "compact" ? n = j : n = i : l === "compact" ? n = h : n = g : l === "compact" && (n = j);
                        f = n + b;
                        e = " bottom: " + f.toString() + "px;";
                        l = "padding: 0; position: fixed; z-index: 2147483646; border-radius: 16px; top: auto; background: none; minHeight: 300px;";
                        n = "width: 399px; ";
                        b = "width: 319px; ";
                        m = (m === "compact" ? b : n) + l + e;
                    ...
                    function s(a, b, c, d, e, f, l) {
                        c = c - k;
                        var m = i + k;
                        f ? (m = k, e === "none" ? l === "compact" ? m += j : m += i : l === "compact" ? m += h : m += g) : l === "compact" && (m = j + k);
                        f = m + b;
                        e = " bottom: " + f.toString() + "px;";
                        l = "padding: 0; position: fixed; z-index: 2147483646;border-radius: 16px; top: auto; width: 247px; max-height: calc(100% - 80px); background: none;" + e;
                        m = l;
                        switch (a) {
                            case "right":
                                m += "right: 4px; margin-right: " + c + "px;";
                ...
                __d("sdk.XFBML.ChatDOM", ["$InternalEnum", "CORSRequest", "ChatPluginEntryPointSizeEnum", "ChatPluginSDKPreLoggingUtils", "ChatPluginStyleUtils", "DOMPlugin", "Log", "UrlMap", "getJSEnumSafe", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.IdleCallback", "sdk.XFBML.CustomerChatNew", "sdk.feature", "uuid"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    ...
                    a = function(a) {
                        ...
                        e.render = function(a) {
                            ...
                            c("CORSRequest").execute(a, "get", this.params, function(a) {
                                ...
                                a = d("ChatPluginStyleUtils").getEntryPointStyle(e, f, g, !1, !0, void 0, !1, b.$ChatDOMFacade8);
                        ...
                        e.$ChatDOMFacade11 = function() {
                            ...
                            var a = this.$ChatDOMFacade8 === "compact" ? d("ChatPluginStyleUtils").ICON_ENTRY_POINT_COMPACT_HEIGHT : d("ChatPluginStyleUtils").ICON_ENTRY_POINT_STANDARD_HEIGHT;
                    ...
                    var h = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
                        ...
                        B = c("IframePlugin").extend({
                            ...
                            _updateDialogIframeOptions: function() {
                                ...
                                if (b != null) try {
                                    a = ES("JSON", "parse", !1, b);
                                    d("MPNExplicitUserInteractions").hasUserInteraction(a == null ? void 0 : a.euit) && ES("Object", "assign", !1, this._params, {
                ...
                __d("sdk.XFBML.Quote", ["DOMEventListener", "IframePlugin", "containsNode", "sdk.DOM", "sdk.UA", "sdk.XD", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    var h = "fb-quotable",
                        i = 155,
                        j = 70,
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "all.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1004819769","namespace":"FB","message":"' + e.message + '"}}');
